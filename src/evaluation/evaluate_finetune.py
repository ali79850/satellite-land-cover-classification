"""
Evaluates the fine-tuned ResNet18 model on the held-out TEST split.
"""
...
CHECKPOINT_PATH = PROJECT_ROOT / "models" / "finetune_best.pth"
FIGURES_DIR = PROJECT_ROOT / "reports" / "figures"
REPORT_PATH = PROJECT_ROOT / "reports" / "finetune_test_evaluation.json"
...
def evaluate():
    ...
    ax.set_title("ResNet18 (Fine-tuned) — Confusion Matrix (Test Set)")
    ...
    plt.colorbar(im)
    plt.tight_layout()
    plt.savefig(FIGURES_DIR / "finetune_confusion_matrix.png", dpi=150)
    plt.show()
